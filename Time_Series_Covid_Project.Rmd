...
Below we are building three sepearte univariate models to predict new Covid cases in Florida. This first model is an ARMA(2,1) model built of the AIC and BIC favored results from above. 
...
forecasts_fl_arima = fore.aruma.wge(newcases_fl$positiveIncrease[i:(i+(trainingSize-1))],phi = fl_arma_21$phi, theta = fl_arma_21$theta, d=1, n.ahead = 12, plot = FALSE)

ensemble_fl_fore = (forecasts_fl_mlp$mean + forecasts_fl_arima$f) / 2
