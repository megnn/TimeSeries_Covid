...
short_fl_ensemble = (short_fl_mlp$mean + short_fl_arma$f)/2
long_fl_ensemble = (long_fl_mlp$mean + long_fl_arma$f)/2
...
#Forecasting ahead
short_ensemble_us = (short_us_mlp$mean +short_us_ar1$f)/2

long_ensemble_us = (long_us_mlp$mean +long_us_ar1$f)/2
